				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:250px; height:250px; position: relative;'/>
								</div>
								<div class='panel-heading'>".CURRENCY." $pro_price.00
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>+</button>
								</div>
							</div>
						</div>	
			";
	...
	if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			...
			echo "<form method='post' action='login_form.php'>";
				...
				if (!isset($_SESSION["uid"])) {
					echo '<input type="submit" style="float:right;" name="login_user_with_product" class="btn-checkout" value="Checkout" >
							</form>';
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="help-umkm@umkmhelp.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/ProjectDB/payment.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/ProjectDB/payment.php">
									<input type="hidden" name="cancel_return" value="http://localhost/ProjectDB/cancel.php"/>
